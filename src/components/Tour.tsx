...
const ALL_STEPS = [
  ...
  { anchor: "games", pt: ["Alternativas embaixo do bilhete", "Dentro do jogo, o bilhete pode vir com até duas alternativas com a mesma ideia. Se uma linha cair ou o número mudar, é só abrir ali."], en: ["Backups under the ticket", "Inside a game, a ticket can come with up to two alternatives with the same idea. If a leg breaks or the line moves, open them right there."] },
  { anchor: "games", pt: ["O selo de escalação", "Uma hora antes do jogo a gente confere quem entrou. Se alguém do seu bilhete ficar no banco, a linha ganha um selo vermelho e a alternativa sem ele fica destacada."], en: ["The lineup badge", "An hour before kickoff we check who starts. If someone on your ticket is benched, the leg gets a red badge and the backup without him is highlighted."] },
  { anchor: "games", pt: ["Raio-x do jogador e o ao vivo", "Dentro do jogo, abra um jogador: linha publicada, quantas vezes ele passou dela, minutagem e o rendimento com e sem cada companheiro. Com a bola rolando, o painel ao vivo diz se cada linha do bilhete já bateu, se caiu ou quanta chance ainda tem."], en: ["Player deep dive and the live panel", "Inside a game, open a player: the posted line, how often he cleared it, his minutes and how he does with and without each teammate. Once the game is on, the live panel says whether each leg has landed, busted or how much chance is left."] },
  { anchor: "nav", pt: ["Múltiplas e histórico", "Combine jogos em múltiplas, monte seu próprio bilhete e acompanhe o histórico do que acertamos e erramos. Na prova pública tem ainda o CLV: cada linha comparada com a odd de fechamento."], en: ["Parlays and track record", "Combine games into parlays, build your own slip, and follow the record of what we got right and wrong. The public record adds CLV: every leg against the closing price."] },
