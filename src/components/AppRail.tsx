...
/**
 * The rail. The everyday destinations, all of them visible at ≥1024px, because a desk tool that
 * hides two thirds of itself behind a hamburger is a website. Between 768 and 1023 it keeps the
 * same order as a 56px column of glyphs; below 768 it leaves and the five most-used destinations
 * become a bottom bar (§14 of docs/DESIGN.md). The doors it does not carry are in the menu, which
 * reads the same file (src/lib/nav.ts) and says what each one is for and what it costs.
 *
...
/**
 * The rail reads src/lib/nav.ts, which is also what the menu reads: the doors marked off the rail
 * there are not missing, they are one tap away in the menu, with a line saying what they are for.
 */
/**
