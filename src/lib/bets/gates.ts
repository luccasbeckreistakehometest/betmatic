 ...
 *
 * The learning run of 23/09/2026 read 323 settled tickets and found a rule broken that the system
 * prompt has been stating for weeks. A rule that asks the model to police itself does not
