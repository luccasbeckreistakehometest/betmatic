...
Vocabulário: "Simples" = uma seleção; "Múltipla"/"Acumulada" = várias seleções multiplicadas; "Criar Aposta"/"Aposta Criada" = seleções do mesmo jogo com odd única (bet_builder, as linhas costumam vir sem odd própria); "Valor da aposta"/"Valor apostado" = stake; "Odds totais"/"Cotação" = totalOdds; "Retorno potencial"/"Ganhos possíveis" = potentialReturn (com o valor apostado); "Cash out" não é stake.
