...
const DICT = {
  ...
  noTicketsYet: { pt: "Ainda não há bilhete gerado para esta partida. A próxima atualização roda em até 4 horas.", en: "No ticket generated for this game yet. The next refresh runs within 4 hours." },
