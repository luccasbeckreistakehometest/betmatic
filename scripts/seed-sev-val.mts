...
function slate(lang: "pt" | "en"): BetSlate {
  ...
  const s: BetSuggestion[] = [
    ticket("p0", ["ag1"],
      ...
      T("A perna de jogador menos cara da partida, e mesmo assim cara. Agoumé comete 1,81 faltas por jogo em 39 partidas medidas e é titular nos quatro jogos da temporada. A 1,09 o preço pede 92% e o histórico entrega 84%.",
    ...
    ticket("p1", ["ag2"],
      ...
      T("−17,9%. O dobro do custo da perna anterior pelo mesmo jogador.", "−17.9%. Twice the cost of the previous leg, same player."),
    ...
    ticket("p2", ["ag1", "djg"],
      ...
      T("Dois jogadores diferentes, então a odd combinada é real: conferi no cupom que Agoumé + Danjuma sai pelo produto das pernas, não com desconto. O problema não é o preço da combinação, é o preço de cada perna.",
    ...
    ticket("p4", ["ag2", "dj2", "djg"],
      T("Três pernas de jogador", "Three player legs"),
      T("Agoumé em 2+ faltas, Danjuma em 2+ finalizações e 1+ no gol. Onde as margens de cada perna se multiplicam em vez de se diluir.",
      ...
      [T("3 pernas — cada uma é mais um jeito de perder", "3 legs — each one is another way to lose")]),
    ticket("p5", ["ag2", "dj2", "djg", "si1"],
      T("Alternativa: quatro pernas", "Alternative: four legs"),
      ...
      T("−86%. Sierra é a perna com a pior distorção do bilhete: 177% acima do medido.", "−86%. Sierra is the worst-distorted leg here: 177% above measured."),
      [T("4 pernas — cada uma é mais um jeito de perder", "4 legs — each one is another way to lose")], "p4"),
    ticket("p6", ["ag3", "dj3", "djg", "jgg"],
      T("Quatro pernas em degraus altos", "Four legs on high rungs"),
  ...
  const note = pt ? [
    ...
    "",
    "CONSEQUÊNCIA: a melhor perna de jogador da partida inteira é −8,8%, e as múltiplas descem até −95%. Não há uma única aposta de jogador com valor positivo neste jogo. Publiquei os bilhetes com o número real em cada um em vez de esconder.",
    "",
    "UMA BOA NOTÍCIA TÉCNICA: pernas de jogadores diferentes multiplicam honestamente. Conferi no cupom — Agoumé 2+ faltas (1,52) com Danjuma 2+ finalizações (1,40) sai a 2,12 contra 2,128 do produto. Então as odds acima são reais e você consegue montá-las. Já pernas correlacionadas do mesmo time levam desconto pesado: 'Sevilha vence' com 'Sevilha mais de 1,5' multiplica 4,19 e o cupom cota 2,45.",
    "",
